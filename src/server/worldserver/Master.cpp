...
int Master::Run()
{
    ...
    sLog->outInfo(LOG_FILTER_WORLDSERVER, "NotaTank Core Rev. 1 (worldserver-daemon)");
    sLog->outInfo(LOG_FILTER_WORLDSERVER, "<Ctrl-C> to stop.\n");
    sLog->outInfo(LOG_FILTER_WORLDSERVER, "NotaTank Core Rev. 1");
...
bool Master::_StartDB()
{
    ...
    sLog->outInfo(LOG_FILTER_WORLDSERVER, "Using World DB: Trinity and NotaTank DB", sWorld->GetDBVersion());
    return true;
}
